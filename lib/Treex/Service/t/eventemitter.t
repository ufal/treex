#!/usr/bin/env perl
# Run this like so: `perl eventemitter.t'
#   Michal Sedlak <sedlakmichal@gmail.com>     2014/05/09 12:07:11

use Test::More;
BEGIN { use_ok( Treex::Service::EventEmitter ); }

# Normal event
my $e = Treex::Service::EventEmitter->new;
my $called;
...
like $@, qr/^Treex::Service::EventEmitter: just/, 'right error';
eval { $e->emit_safe(error => 'works') };
like $@, qr/^Treex::Service::EventEmitter: works/, 'right error';
...
like $@, qr/^Treex::Service::EventEmitter: Event "error" failed: intentional/,
  'right error';
...
$e = Treex::Service::EventEmitter->new;
my $counter;
