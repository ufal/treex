package Treex::Tools::Vallex::FrameElement;
...
sub _get_conversion_table {
    ...
    if ( !Treex::Tools::Vallex::FrameElement->_loaded_conversion->{$language} ) {
        ...
        Treex::Tools::Vallex::FrameElement->_loaded_conversion->{$language} = $conversion;
    }
    return Treex::Tools::Vallex::FrameElement->_loaded_conversion->{$language};
}
...
Treex::Tools::Vallex::FrameElement

=head1 DESCRIPTION

This object represents a single element of a L<Treex::Tools::Vallex::ValencyFrame>, storing its functor, obligatoriness and 
possible surface realizations (as TectoMT-style formemes).

=head1 SYNOPSIS

    # create a frame element from scratch
    my $el = Treex::Tools::Vallex::FrameElement->new({functor => 'ACT', oblig => 1, forms => {'n:1' => 1} });
...
=item C<new>
    ...
    $el = Treex::Tools::Vallex::FrameElement->new({functor => 'ACT', oblig => 1, forms => {'n:1' => 1} });
