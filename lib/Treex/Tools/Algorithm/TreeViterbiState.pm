...
Treex::Tools::Algorithm::TreeViterbiState - state for use in TreeViterbi algorithm
...
This is base class for use in L<Treex::Tools::Algorithm::TreeViterbi> algorithm.
