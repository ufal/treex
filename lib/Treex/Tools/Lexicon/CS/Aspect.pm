package Treex::Tools::Lexicon::CS::Aspect;
...
#TODO (MP): rewrite Treex::Tools::Lexicon::CS::Aspect from scratch
...
Treex::Tools::Lexicon::CS::Aspect

=head1 SYNOPSIS

use Treex::Tools::Lexicon::CS::Aspect;
if (    Treex::Tools::Lexicon::CS::Aspect::get_verb_aspect('čekat')     eq 'P'
    and Treex::Tools::Lexicon::CS::Aspect::get_verb_aspect('čekávat')   eq 'I'
    and Treex::Tools::Lexicon::CS::Aspect::get_verb_aspect('adresovat') eq 'B')
{
    print "OK\n";    
}
