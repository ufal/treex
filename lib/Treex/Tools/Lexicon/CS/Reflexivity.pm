package Treex::Tools::Lexicon::CS::Reflexivity;
...
Treex::Tools::Lexicon::CS::Reflexivity

=head1 SYNOPSIS

 use Treex::Tools::Lexicon::CS::Reflexivity;
 
 foreach my $lemma (qw(chodit zeptat troufat)) {
     print Treex::Tools::Lexicon::CS::Reflexivity::fix_reflexivity($lemma)."\n";
 }
...
=item my $corrected_tlemma = Treex::Tools::Lexicon::CS::Reflexivity::fix_reflexivity($tlemma);
