...
For many other languages, there are pre-trained TreeTagger models.
 ...
 echo "Bohužel jsem tento tutorial nedokončil." |\
  treex -Lcs Read::Sentences W2A::CS::Tokenize W2A::CS::TagFeaturama Write::CoNLLX

If you suceeded to install Morče tagger, you can substitute C<W2A::EN::TagFeaturama>
with C<W2A::EN::TagMorce>.
