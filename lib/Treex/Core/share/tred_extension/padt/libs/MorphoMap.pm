...
# $Id: MorphoMap.pm 607 2008-07-09 21:48:32Z smrz $
...
our $VERSION = '1.9' || do { q $Revision: 607 $ =~ /(\d+)/; sprintf "%4.2f", $1 / 100 };
...
=head1 REVISION
    ...
    $Revision: 607 $       $Date: 2008-07-09 23:48:32 +0200 (Wed, 09 Jul 2008) $
