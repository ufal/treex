...
sub Parse::RecDescent::Treex::Core::ScenarioParser::TBNAME
{
    ...
    my $lastsep="";
    my $current_match;
    my $expectation = new Parse::RecDescent::Expectation(q{BNAME});
    $expectation->at($_[1]);
...
sub Parse::RecDescent::Treex::Core::ScenarioParser::PARAM
{
    ...
    while (!$_matched && !$commit)
    {
        ...
        Parse::RecDescent::_trace(q{Trying production: [PNAME '=' PVALUE]},
                      Parse::RecDescent::_tracefirst($_[1]),
                      q{PARAM},
                      $tracelevel)
                        if defined $::RD_TRACE;
        ...
        Parse::RecDescent::_trace(q{>>Matched production: [PNAME '=' PVALUE]<<},
                      Parse::RecDescent::_tracefirst($text),
                      q{PARAM},
                      $tracelevel)
                        if defined $::RD_TRACE;
