...
cmp_ok ($doc->get_zone('en'), 'eq', $zone1, 'created zone found by get_zone');
...
cmp_ok ($doc2->get_zone('en')->get_attr('text'), 'eq', $sample_text, 'document zone attribute correctly stored in a file');
