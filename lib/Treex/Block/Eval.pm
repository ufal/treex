...
Treex::Block::Eval - Special block for evaluating code given by parameters.

=head1 SYNOPSIS

  # on the command line
  treex Eval document='print $document->full_filename' -- *.treex
  treex Eval language=en anode='print $anode->lemma' -- *.treex
