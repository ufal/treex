package Treex::Block::W2A::EN::ParseZpar;
use Moose;
...
Treex::Block::W2A::EN::ParseZpar

=head1 DECRIPTION

ZPar parser (developed by Yue Zhang and Joakim Nivre,
see http://www.cl.cam.ac.uk/~yz360/zpar.html)
