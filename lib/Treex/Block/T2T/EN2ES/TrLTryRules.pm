package Treex::Block::T2T::EN2ES::TrLTryRules;
use utf8;
use Moose;
...
Readonly my %QUICKFIX_TRANSLATION_OF => (
    'uninstall'          => 'desinstalar|verb',
    're-install'         => 'reinstalar|verb',
    'reinstall'          => 'reinstalar|verb',
    'download'           => 'descargar|verb',
    'unplug'             => 'desenchufar|verb',
#    'try'                => 'probar|verb',
    'printer'            => 'impresora|noun',
    'driver'             => 'controlador|noun',
    'charger'            => 'cargador|noun',
    'unstaller'          => 'desinstalador|noun',
    'mouse'              => 'ratón|noun',
    'browser'            => 'navegador|noun',
    'tab'                => 'etiqueta|noun',
    'gear'               => 'tuerca|noun',
...
sub get_lemma_and_pos {
    ...
    if ($src_tlemma =~ /^#/ && $src_formeme eq 'n:subj') {
...
=item Treex::Block::T2T::EN2ES::TrLTryRules
