package SEnglishT_to_TCzechT::Recompute_deepord;
...
=item SEnglishT_to_TCzechT::Recompute_deepord

When finishing the topological changes of TCzechT trees, the C<deepord>
