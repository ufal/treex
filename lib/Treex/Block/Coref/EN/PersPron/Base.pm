...
sub _build_feature_extractor {
    ...
    #if (($self->has_model_type && $self->model_type =~ /with_/) || $self->aligned_feats) {
...
This role is a basis for supervised coreference resolution of English personal pronouns.
