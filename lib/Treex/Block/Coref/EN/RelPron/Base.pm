package Treex::Block::Coref::EN::RelPron::Base;
use Moose::Role;
...
sub _build_feature_extractor {
    ...
    my $en_fe = Treex::Tool::Coreference::Features::RelPron->new();
    return $en_fe;
...
Treex::Block::Coref::EN::PersPron::Base

=head1 DESCRIPTION

This role is a basis for supervised coreference resolution of English relative pronouns.
