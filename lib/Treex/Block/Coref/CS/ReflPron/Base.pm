package Treex::Block::Coref::CS::ReflPron::Base;
use Moose::Role;
use Treex::Core::Common;

use Treex::Tool::Coreference::AnteCandsGetter;
use Treex::Tool::Coreference::Features::CS::ReflPron;
...
sub _build_feature_extractor {
    ...
    my $cs_fe = Treex::Tool::Coreference::Features::CS::ReflPron->new();
    return $cs_fe;
...
Treex::Block::Coref::CS::ReflPron::Base

=head1 DESCRIPTION

This role is a basis for supervised coreference resolution of Czech reflexive pronouns.
