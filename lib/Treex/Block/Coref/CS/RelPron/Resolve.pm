...
override '_build_model_for_type' => sub {
    ...
    return {
        ...
        'pcedt_bi' => "$dir/022_run_2017-03-10_10-32-59_18713.PCEDT.mono.instance_num_fixed/001.17cb9c0d6f.featset/021.85801.mlmethod/model/train.pcedt_bi.table.gz.vw.ranking.model",
        
        # PCEDT.crosslingual aligned_all
        'pcedt_bi.with_en' => "$dir/023_run_2017-03-10_10-33-09_18872.PCEDT.cross.instance_num_fixed/002.88233bf9a2.featset/022.88cd4.mlmethod/model/train.pcedt_bi.with_en.table.gz.vw.ranking.model",
        # PCEDT.crosslingual aligned_all+coref+mono_all
        'pcedt_bi.with_en.treex_cr' => "$dir/023_run_2017-03-10_10-33-09_18872.PCEDT.cross.instance_num_fixed/004.7f391f3429.featset/022.88cd4.mlmethod/model/train.pcedt_bi.with_en.table.gz.vw.ranking.model",
        
        # PCEDT.crosslingual-baseline aligned_all+coref+mono_all
        'pcedt_bi.with_en.base_cr' => "$dir/024_run_2017-03-10_10-33-19_19030.PCEDT.cross-base.instance_num_fixed/004.7f391f3429.featset/022.88cd4.mlmethod/model/train.pcedt_bi.with_en.baseline.table.gz.vw.ranking.model",
    };
};
