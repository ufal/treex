...
This block prints three lines for each sentence (bundle), e.g.:
 ...
 _ROOT n:subj Shaw v:fin curse n:obj #PersPron n:poss #PersPron n:under+X breath v:for+ger start adv here   0 3 2 0 4 3 6 9 8 3 10 9 12 11 14
 _ROOT n:1 Shaw n:v+6 duch n:na+4 #PersPron v:fin zlobit_se drop #PersPron v:že+fin začít adv tady          0 7 2 7 4 7 6 0 8 11 10 7 12 11 14
 0-0 2-2 1-1 10-4 9-3 12-12 11-11 14-14 13-13
