package Treex::Block::HamleDT::JA::GoogleToUdep;
use utf8;
use Moose;
...
=item Treex::Block::HamleDT::JA::GoogleToUdep

Converts Japanese trees from the Google Universal Dependency Treebanks
