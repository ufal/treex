...
BEGIN
{
    ...
    (
        ...
        ['a tedy , že',        'fixed',   'a tedy , že',        'CCONJ CCONJ PUNCT SCONJ', 'J^------------- J^------------- Z:------------- J,-------------', 'pos=conj|conjtype=coor pos=conj|conjtype=coor pos=punc pos=conj|conjtype=sub', '0:cc 0:cc 0:punct 0:mark'],
