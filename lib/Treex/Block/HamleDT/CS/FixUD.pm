...
BEGIN
{
    ...
    (
        ...
        ['to znamená , aniž',  'fixed',   'ten znamenat , aniž', 'DET VERB PUNCT SCONJ', 'PDNS1---------- VB-S---3P-AAI-- Z:------------- J,-------------', 'pos=adj|prontype=dem|gender=neut|number=sing|case=nom|extpos=cconj pos=verb|polarity=pos|number=sing|person=3|verbform=fin|mood=ind|tense=pres|voice=act|aspect=imp pos=punc pos=conj|conjtype=sub', '0:cc 1:fixed 0:punct 0:mark'],
        ['to znamená , až',    'fixed',   'ten znamenat , až',  'DET VERB PUNCT SCONJ', 'PDNS1---------- VB-S---3P-AAI-- Z:------------- J,-------------', 'pos=adj|prontype=dem|gender=neut|number=sing|case=nom|extpos=cconj pos=verb|polarity=pos|number=sing|person=3|verbform=fin|mood=ind|tense=pres|voice=act|aspect=imp pos=punc pos=conj|conjtype=sub', '0:cc 1:fixed 0:punct 0:mark'],
