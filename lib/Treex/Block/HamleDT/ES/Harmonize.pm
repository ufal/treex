...
###!!! NOTE that this block is more or less identical to that of Catalan. The
###!!! code has been copied from CA::Harmonize (thus the examples in the
###!!! comments below are Catalan, not Spanish). In the future we should
###!!! create a common predecesor of these two blocks and move the bulk of
###!!! the code there.
...
Converts Spanish trees from CoNLL to the HamleDT (Prague) style.
