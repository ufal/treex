...
(
    ...
    'appos', 'nmod', 'amod', 'det', 'nummod', 'acl', 'case',
...
(
    ...
    'cs'  => ['advmod:emph', 'det:numgov', 'det:nummod', 'expl:pass', 'nummod:gov'],
    ...
    'es'  => ['acl:relcl', 'det:nummod', 'expl:pass'],
    ...
    'la'  => ['advmod:emph', 'expl:pass'],
    'nl'  => ['compound:prt', 'det:nummod'],
    'no'  => ['acl:relcl', 'compound:prt'],
    'pl'  => ['det:numgov', 'det:nummod', 'nummod:gov'],
    'pt'  => ['acl:inf', 'acl:part', 'acl:relcl', 'advmod:emph', 'det:poss', 'expl:pass', 'xcomp:adj'],
