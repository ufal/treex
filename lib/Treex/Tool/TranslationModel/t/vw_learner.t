...
$model->save('t/vw.model.gz');
my $loaded_model = Treex::Tool::TranslationModel::ML::Model->new({model_type => 'vw'});
$loaded_model->load('t/vw.model.gz');
