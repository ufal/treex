...
has tmp_dir => (
	is				=> 'ro',
	isa				=> 'Str',
	default			=> '/a/LRC_TMP/varis/mlfix/python',
	documentation	=> 'directory, where the temp files are stored to avoid passing long string arguments to the python bipipe'
);
