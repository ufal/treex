package Treex::Tool::Lexicon::CS::Numerals;

use strict;
use warnings;
use utf8;

# Returns 1 for non-congruent numerals, i.e. indefinite "(ně)kolik" etc. or definite fraction or 5 and higher (negative as well)
...
Treex::Tool::Lexicon::CS::Numerals
