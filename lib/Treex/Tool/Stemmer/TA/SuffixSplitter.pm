package Treex::Tool::Stemmer::TA::SuffixSplitter;
use utf8;
use Moose;
use autodie;
...
my $verb_suffixes_file = require_file_from_share("$data_dir/verb_suffixes_npfl087.txt");
my $noun_suffixes_file = require_file_from_share("$data_dir/noun_suffixes_npfl087.txt");
