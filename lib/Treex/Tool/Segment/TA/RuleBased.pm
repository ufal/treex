...
my $UNBREAKERS = qr {
	    டபிள்யூ|திருமதி|திரு|செல்வி|ஙை|ஞை|ஷை|ஷௌ|ஙௌ|ஞௌ|ஙெ|னௌ|வௌ|றௌ|னை|ஷி|ஷு|ஷெ|
ஜௌ|ஹை|ஹௌ|ரௌ|நௌ|ழௌ|ஷோ|ணௌ|ரை|ளை|ளௌ|லௌ|வை|றை|டை|க்ஷௌ|ஙா|ஷீ|ஷா|
பௌ|ஞோ|நை|ஙொ|ஞூ|ஙு|ஸை|ஸௌ|ங|ஷே|ஷொ|ஙூ|ஜை|ழை|மௌ|யௌ|கௌ|ஷ|யை|
ஞெ|கை|ஞு|ஞே|க்ஷை|டௌ|ஸ்ரீ|ஞொ|ஙே|ஙோ|ஙீ|பை|ஞி|ஞீ|சை|சௌ|மை|ஞ|ஙி|
தௌ|தை|லை|ஞா|ஷூ|ணை|எப்|எச்|எல்|எம்|என்|ஆர்|எஸ்|ளூ|றி|று|ளே|ரா|ளா|னெ|ரி|றோ|றெ|ரீ|றொ|றூ|ளெ|னோ|ழா|சே|
லெ|யீ|லோ|ஸூ|லு|லூ|வீ|வூ|ச|வோ|யூ|ணி|ழெ|ரே|ழு|ரெ|ழொ|ழே|ரோ|னா|லா|ஜீ|ழீ|பே|தொ|
ய|வ|ப|யா|ல|ர|ந|ஔ|ட|ஹா|நே|வெ|க|றீ|நு|லி|க்ஷ|ன|ணா|யு|ஹீ|டெ|ற|ள|ளி|
ஸ|ஹ|ஜு|ரொ|ஜி|ஜொ|ஜே|ஜெ|கீ|ளீ|னு|னீ|ரு|டி|னே|ஸோ|லீ|ஸீ|நீ|ஸொ|ஸே|தி|ஸா|மெ|ஸி|
ஹி|ஷ்|ஹே|ஹெ|க்ஷே|கொ|க்ஷூ|த|ங்|ஜூ|க்ஷோ|க்ஷொ|வு|லொ|ம|க்ஷு|க்ஷீ|நா|க்ஷா|சா|கோ|ளொ|கி|சூ|சு|
ணு|சி|கா|றே|ஞ்|கே|கெ|கூ|ஜா|ணூ|ண|ஸு|தா|வொ|க்ஷெ|னூ|ளோ|ஜோ|பூ|சொ|ழோ|றா|கு|பீ|ளு|
னி|தூ|ஹொ|ணொ|து|ழூ|நொ|தீ|ஸெ|தோ|ழ|தே|ழி|பெ|பு|ஐ|வா|மா|போ|பொ|நெ|நூ|வே|பி|பா|
நோ|ஹோ|லே|யி|மூ|செ|யொ|யே|யெ|மு|மீ|தெ|மோ|மொ|மே|வி|ஜ|டூ|டு|டோ|டொ|டே|டீ|ரூ|யோ|
மி|னொ|டா|சோ|க்ஷி|ணே|ணெ|ஹூ|ஹு|நி|ணீ|சீ|ணோ|இ|அ|த்|ஸ்|ன்|ச்|ஹ்|ப்|ஓ|ஒ|ஃ|உ|ய்|எ|ட்|வ்|ம்|க்|
அ|ஈ|ஏ|ஊ|ழ்|ற்|ல்|ர்|ள்|ஜ்|ந்|ண்|ஆ|க்ஷ்
}x;
