...
my $parser = Treex::Tool::Parser::Charniak::Charniak->new();

isa_ok($parser,'Treex::Tool::Parser::Charniak::Charniak','parser instantiated');

my @tokens = qw(John loves Mary);

my $tree_root = $parser->parse(@tokens);

isa_ok ($tree_root, 'Treex::Tool::Parser::Charniak::Node', 'tree root is Parser::Charniak::Node');
