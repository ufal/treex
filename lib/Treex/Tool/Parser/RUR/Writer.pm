package Treex::Tool::Parser::RUR::Writer;
...
sub write_tsv {
    ...
    # (Str $filename,
    # ArrayRef[Treex::Tool::Parser::RUR::Sentence] $sentences)
...
Treex::Tool::Parser::RUR::Writer

=head1 DESCRIPTION

Writes L<Treex::Tool::Parser::RUR::Sentence> instances
