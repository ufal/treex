package Treex::Tool::Parser::RUR::FeaturesControl;
...
has pmi_model => (
    is      => 'rw',
    isa     => 'Maybe[Treex::Tool::Parser::RUR::ModelAdditional]',
    default => undef,
);
...
Treex::Tool::Parser::RUR::FeaturesControl
...
(L<Treex::Tool::Parser::RUR::Sentence>) stored in C<sentence> field).
...
L<Treex::Tool::Parser::RUR::Node/fields>) and a reference to a subroutine
(one of the C<feature_*> subs, see below) which computes the feature value
based on the field index and the edge (L<Treex::Tool::Parser::RUR::Edge>).
...
L<Treex::Tool::Parser::RUR::Edge/signature>), the value is
...
(see L<Treex::Tool::Parser::RUR::Edge>). If
