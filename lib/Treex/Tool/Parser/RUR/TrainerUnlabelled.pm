package Treex::Tool::Parser::RUR::TrainerUnlabelled;

use Moose;

extends 'Treex::Tool::Parser::RUR::TrainerBase';

use Treex::Tool::Parser::RUR::Parser;

has model => (
    isa => 'Treex::Tool::Parser::RUR::ModelUnlabelled',
    is  => 'rw',
);

has parser => (
    isa => 'Treex::Tool::Parser::RUR::Parser',
    is  => 'rw',
);
...
sub BUILD {
    ...
    $self->parser(
        Treex::Tool::Parser::RUR::Parser->new( config => $self->config )
    );
...
sub update {
    ...
    # (Treex::Tool::Parser::RUR::Sentence $sentence_correct_parse,
    # Int $sumUpdateWeight)
    my (
        $self,
...
sub mira_update {
    ...
    # (Treex::Tool::Parser::RUR::Sentence $sentence_correct_parse,
    # Treex::Tool::Parser::RUR::Sentence $sentence_best_parse,
    # Int $sumUpdateWeight)
    my (
        $self,
        $sentence_correct_parse,
...
Treex::Tool::Parser::RUR::TrainerUnlabelled
...
Reference to an instance of L<Treex::Tool::Parser::RUR::Parser> which is
used for the training.

=item model

Reference to an instance of L<Treex::Tool::Parser::RUR::ModelUnlabelled>
...
(L<Treex::Tool::Parser::RUR::FeaturesControl/number_of_iterations>, C<10>
