package Treex::Tool::Parser::RUR::Parser;
...
use Treex::Tool::Parser::RUR::ModelUnlabelled;
...
has model => (
    isa => 'Maybe[Treex::Tool::Parser::RUR::ModelUnlabelled]',
    is  => 'rw',
);
...
sub BUILD {
    ...
    $self->model(
        Treex::Tool::Parser::RUR::ModelUnlabelled->new(
            config => $self->config,
            )
    );
...
Treex::Tool::Parser::RUR::Parser - pure Perl implementation of MST parser
...
Parses a sentence (instance of L<Treex::Tool::Parser::RUR::Sentence>). It
sets the C<parent> field of each node (instance of
L<Treex::Tool::Parser::RUR::Node>), i.e. a word in the sentence, and also
...
L<Treex::Tool::Parser::RUR::Sentence/copy_nonparsed>).

=item $parser->parse_sentence_internal($sentence);

Does the actual parsing, returning a parsed instance of
L<Treex::Tool::Parser::RUR::Sentence>. The C<parse_sentence> sub is
