package Treex::Tool::Parser::RUR::Reader;
...
sub read_tsv {
    ...
    while (<$file>) {
        chomp;
        if (/^$/) {
            my $sentence = Treex::Tool::Parser::RUR::Sentence->new(
                id => $id++, nodes => [@nodes],
                config => $self->config
            );
            ...
            my $node = Treex::Tool::Parser::RUR::Node->new(
                fields => [@fields],
                config => $self->config
            );
            push @nodes, $node;
...
and converts it to L<Treex::Tool::Parser::RUR::Node> and
L<Treex::Tool::Parser::RUR::Sentence> instances.
...
(instances of L<Treex::Tool::Parser::RUR::Sentence>).

The structure of the file (the order of the fields)
is determined by the C<config> field
(instance of L<Treex::Tool::Parser::RUR::Config>),
