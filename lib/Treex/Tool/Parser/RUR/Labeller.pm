package Treex::Tool::Parser::RUR::Labeller;

use Moose;
use Carp;

use Treex::Tool::Parser::RUR::Sentence;
use Treex::Tool::Parser::RUR::Edge;
use Treex::Tool::Parser::RUR::ModelLabelling;
...
has model => (
    isa => 'Maybe[Treex::Tool::Parser::RUR::ModelLabelling]',
    is  => 'rw',
);
...
sub BUILD {
    ...
    $self->model(
        Treex::Tool::Parser::RUR::ModelLabelling->new(
            config => $self->config,
            )
    );
...
sub label_sentence_internal {
    ...
    if ( !$self->model ) {
        croak "RUR parser error: There is no model for labelling!";
    }
...
sub label_subtree {
    ...
    # (Treex::Tool::Parser::RUR::Node $parent)
    my ( $self, $parent ) = @_;
...
Treex::Tool::Parser::RUR::Labeller - pure Perl implementation
...
the MST parser (L<Treex::Tool::Parser::RUR::Parser>), possibly
non-projective - assigns the most probable labels to the edges of the tree,
using the given model (L<Treex::Tool::Parser::RUR::ModelLabelling>).
...
L<Treex::Tool::Parser::RUR::TrainerLabelling>.
...
Instance of L<Treex::Tool::Parser::RUR::Config> containing settings to be
used with labeller.
...
See L<Treex::Tool::Parser::RUR::Config/VITERBI_STATES_NUM_THRESHOLD>.

=item labeller_algorithm

See L<Treex::Tool::Parser::RUR::Config/labeller_algorithm>.

=item labelledFeaturesControl

See L<Treex::Tool::Parser::RUR::Config/labelledFeaturesControl>.

=item SEQUENCE_BOUNDARY_LABEL

See L<Treex::Tool::Parser::RUR::Config/SEQUENCE_BOUNDARY_LABEL>.

=back

=item model

An instance of L<Treex::Tool::Parser::RUR::ModelLabelling>
...
=item my $labeller = Treex::Tool::Parser::RUR::Labeller->new(
config => $self->config);
...
using L<Treex::Tool::Parser::RUR::ModelBase/load>
or L<Treex::Tool::Parser::RUR::ModelBase/load_tsv>.
...
Labels a sentence (instance of L<Treex::Tool::Parser::RUR::Sentence>). It
...
L<Treex::Tool::Parser::RUR::Sentence>. The C<label_sentence> sub is
...
L<Treex::Tool::Parser::RUR::Sentence> (which is labelled), use
