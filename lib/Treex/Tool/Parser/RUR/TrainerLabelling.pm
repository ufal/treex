package Treex::Tool::Parser::RUR::TrainerLabelling;

use Moose;
use Carp;

extends 'Treex::Tool::Parser::RUR::TrainerBase';

use Treex::Tool::Parser::RUR::Labeller;

has model => (
    isa => 'Treex::Tool::Parser::RUR::ModelLabelling',
    is  => 'rw',
);

has labeller => (
    isa => 'Treex::Tool::Parser::RUR::Labeller',
    is  => 'rw',
);
...
sub BUILD {
    ...
    $self->labeller(
        Treex::Tool::Parser::RUR::Labeller->new( config => $self->config )
    );
...
sub compute_unigram_counts {
    ...
    # (Treex::Tool::Parser::RUR::Node $parent_node)
    my ( $self, $sentence ) = @_;
...
sub update {
    ...
    # (Treex::Tool::Parser::RUR::Sentence $sentence_correct_labelling,
    # Int $sumUpdateWeight)
    my (
        $self,
...
sub mira_update {
    ...
    # (Treex::Tool::Parser::RUR::Sentence $sentence_correct_labelling,
    # Treex::Tool::Parser::RUR::Sentence $sentence_best_labelling,
    # Int $sumUpdateWeight)
    my (
        $self,
        $sentence_correct_labelling,
...
sub mira_tree_update {
    ...
    # (Treex::Tool::Parser::RUR::Node $correct_parent,
    # Treex::Tool::Parser::RUR::Sentence $sentence_best_labelling,
    # Int $sumUpdateWeight)
    my (
        $self,
...
Treex::Tool::Parser::RUR::TrainerLabelling
...
Reference to an instance of L<Treex::Tool::Parser::RUR::Labeller> which is
used for the training.

=item model

Reference to an instance of L<Treex::Tool::Parser::RUR::ModelLabeller>
...
(L<Treex::Tool::Parser::RUR::Sentence>), which can be obtained by the
L<Treex::Tool::Parser::RUR::Reader>.
