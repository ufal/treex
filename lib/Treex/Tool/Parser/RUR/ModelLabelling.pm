package Treex::Tool::Parser::RUR::ModelLabelling;

use Moose;
use Carp;

extends 'Treex::Tool::Parser::RUR::ModelBase';
...
has 'EM_heldout_data' => (
    is      => 'rw',
    isa     => 'ArrayRef[Treex::Tool::Parser::RUR::Sentence]',
    default => sub { [] },
);
...
Treex::Tool::Parser::RUR::ModelLabelling

=head1 DESCRIPTION

This is an in-memory represenation of a labelling model,
extended from L<Treex::Tool::Parser::RUR::ModelBase>.

=head1 FIELDS

=head2 Inherited from base package

Fields inherited from L<Treex::Tool::Parser::RUR::ModelBase>.
...
See L<Treex::Tool::Parser::RUR::Config/EM_EPSILON>.
...
Subroutines inherited from L<Treex::Tool::Parser::RUR::ModelBase>.
...
See L<Treex::Tool::Parser::RUR::ModelBase/store>.

=item store_tsv

See L<Treex::Tool::Parser::RUR::ModelBase/store_tsv>.

=item load

See L<Treex::Tool::Parser::RUR::ModelBase/load>.

=item load_tsv

See L<Treex::Tool::Parser::RUR::ModelBase/load_tsv>.

=back

=head2 Overriden

Subroutines overriding stubs in L<Treex::Tool::Parser::RUR::ModelBase>.
...
=item BUILD
 ...
 my $model = Treex::Tool::Parser::RUR::ModelLabelling->new(
    config => $config,
 );
...
(L<Treex::Tool::Parser::RUR::Labeller>)
...
L<Treex::Tool::Parser::RUR::Labeller/load_model>
and
L<Treex::Tool::Parser::RUR::Labeller/load_model_tsv>
which you can call to load the model from a file.
(Btw. as you might expect, the trainer provides methods
L<Treex::Tool::Parser::RUR::TrainerLabelling/store_model>
and
L<Treex::Tool::Parser::RUR::TrainerLabelling/store_model_tsv>.)
