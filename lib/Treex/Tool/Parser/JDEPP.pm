...
Treex::Tools::Parser::JDEPP - perl wrapper for C implemented japanese dependency parser JDEPP

=head1 DESCRIPTION

This is a Perl wrapper for JDEPP Parser implemented in C.
Parser homepage: http://www.tkl.iis.u-tokyo.ac.jp/~ynaga/jdepp/
This parser works with tokens and POS tags generated by MeCab tagger for dependency parsing. Tokens are grouped together into "bunstetsu", then parsing is performed on these bunsetsu. Dependencies between each tokens are generated later in this module.
