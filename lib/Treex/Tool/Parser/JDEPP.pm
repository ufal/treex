...
You can also install JDEPP manually but then you must link the installation directory to the ${TMT_ROOT}/share/installed_tools/parser/jdepp/ (location within Treex share), otherwise the modules will not be able to use the program.
...
L<JDEPP Home Page|http://www.tkl.iis.u-tokyo.ac.jp/~ynaga/jdepp/> for more info on JDEPP parser
