package Treex::Tool::Algorithm::TreeViterbi;
...
Treex::Tool::Algorithm::TreeViterbi - algorithm for finding optimal hidden states of Hidden Markov Tree Model
...
=head1 SYNOPSIS
 ...
 my @states = Treex::Tool::Algorithm::TreeViterbi::run( $root, \&get_states_of );
...
=item my @root_states = Treex::Tool::Algorithm::TreeViterbi::run($root, $get_states_ref)
